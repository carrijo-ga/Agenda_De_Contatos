...
<head>
    ...
    <link rel="stylesheet" href="../css/tiposdecontatos.css" type="text/css">
...
<body>
    ...
    <div class="container">
        ...
        <!-- Botão NovoContato-1 -->
        <a href="../backend/pages/tipodecontato.php?idTipoDeContato=0">
            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr class="contact-fields">
                        ...
                        <td><?php echo $nome; ?></td>
                        <td>Contatos</td>
                        <td><a href="../backend/pages/tipodecontato.php?idTipoDeContato=<?php echo $idTipoDeContato; ?>"><button type="button" class="btn btn-warning">Alterar</button></a></td>
                        <td>
                            <a href="../backend/save/excluirtipodecontato.php?idTipoDeContato=<?php echo $idTipoDeContato; ?>">
